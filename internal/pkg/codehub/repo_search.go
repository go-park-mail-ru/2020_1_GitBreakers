...
type RepoSearchI interface {
	...
	GetFromStarredRepos(query string, limit int64, offset int64) (models.RepoSet, error)
	GetFromAllRepos(query string, limit int64, offset int64) (models.RepoSet, error)
	GetFromOwnRepos(query string, limit int64, offset int64) (models.RepoSet, error)
}
